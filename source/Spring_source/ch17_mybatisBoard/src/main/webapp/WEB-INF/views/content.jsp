...
<!--	${content_view } ${param.bid } ${param.pageNum }  -->
	<table>
		...
		<tr>
			<td colspan="2">
				<button onclick="location.href='updateView.do?bid=${param.bid}&pageNum=${param.pageNum}'">수정</button>
				<button onclick="location.href='delete.do?bid=${param.bid}&pageNum=${param.pageNum}'">삭제</button>
				<button onclick="location.href='replyView.do?bid=${param.bid}&pageNum=${param.pageNum}'">답변</button>
