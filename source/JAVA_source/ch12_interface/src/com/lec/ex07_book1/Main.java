...
public class Main {
	...
	public static void main(String[] args) {
		...
		Book[] books = {new Book("890ㅁ-101-1ㄱ","java","홍길동"),
						new Book("111ㄱ-111-1ㄱ","dbms","신길동"),
						new Book("111ㄴ-111-1ㄴ","web","김길동"),
						new Book("111ㄷ-111-1ㄷ","jsp","고길동"),
						new Book("111ㄹ-111-1ㄹ","spring","박길동")};
		...
		do {
			...
			switch (fn) {
			case 1:
				//대출: 1.책이름 입력 2.책조회 3.책상태확인 4.대출인입력 5.대출일입력 6.대출메소드 호출
				//1.책이름입력
