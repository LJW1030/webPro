...
public class BoardDao {
	...
	// bid로 dto가져오기=수정하기+답변쓰기(조회수 올리기 포함 x)
	public BoardDto modify_reply_View(int bid) {
		BoardDto dto = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	// 답변글 쓰기 전 step
	private void preReply(int bgroup, int bstep) {
		Connection        conn  = null;
		PreparedStatement pstmt = null;
